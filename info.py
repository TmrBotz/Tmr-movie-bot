...
BOT_TOKEN = environ.get('BOT_TOKEN', "7473136514:AAGXR0fJksJi--Px-6bubObUR_gUUt_MMXo")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/09973eb32ed7f72468dc3.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6987799874').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002041860613)

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002041860613').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002001105061') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002150048594').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tmrbotz:3x2hf58P4GeI4mCb@cluster0.ron8u.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Tmr_botz")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+tXihI-NQARAwMzY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movie01material')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Tmr_Botz_Support') # Support Chat Link Without https:// or @
