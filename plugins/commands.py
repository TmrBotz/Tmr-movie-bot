...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgQAAxkBAALPCGb-R9SFuUbwtKZ562eBzEiONIIKAAIXEgACvNP4U6ZhTSAt4m7vNgQ") 
    ...
    if not files_:
        ...
        try:
            ...
            btn = [[
                InlineKeyboardButton("Get File Again", callback_data=f'https://t.me/TMR_movie_request_group')
            ]]
